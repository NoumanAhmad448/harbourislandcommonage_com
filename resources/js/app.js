...
//         });
//     }else{
//         const msg = `element with ${gallery_slider} class not found`
//         if(debug){
//             console.log(msg)
//         }else{
//             console.warn(msg)
...
//         });
//     }else{
//         const msg = `element with ${thumbnail_slider} class not found`
//         if(debug){
//             console.log(msg)
//         }else{
//             console.warn(msg)
...
//             $(`#${notice}`).slideUp("slow");
//         }else{
//             const msg = `element with ${notice} id not found`
//             if(debug){
//                 console.log(msg)
//             }else{
//                 console.warn(msg)
